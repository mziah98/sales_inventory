...
$sql = "SELECT stock.StockNo,cus_order.OrderNo,CusPhoneNo,StockName,OrderQuantity,OrderQuantity*stock.SellingPrice as total,OrderDate,
  CusName,CusAdd,CusEmail,SUM(OrderQuantity) as OrderQuantity,StatusPayment,stock.SellingPrice,AmountPaid,cus_order.Balance FROM stock,cus_order
  where   stock.StockNo=cus_order.StockNo group by StockName";	
...
$dataPoints = array();
 ...
 {
	$point = array("label" => $row['StockName'],"y" => $row['OrderQuantity']);

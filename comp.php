...
<head>
 ...
 <!--  <link rel="stylesheet" href="navbar.css"> -->
  ...
  <!--title>PHP and MySQL CRUD</title-->
                ...
                <br><br>
              <h2><center>Computer </h2></center>

  <br>

  
          <div class="col-md-2 float-right add-new-button">
            <a  text-align="center" float="right" target="_blank" class="btn btn-success btn-block" button onclick="window.print()">
...
<form action=""  method="post">
          ...
          <td>
            ...
            <a button type="button" onClick="return confirm('Are you sure to delete?')" href="deletecomp.php?StockNo=<?php echo $result2["StockNo"] ;?>" class="btn btn-danger deleteBtn"  data-target="#delete">
        Delete </a>
            </button>

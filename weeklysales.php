...
//$purname= $_GET['PurID'];
$dt= date("Y");
$sql = "SELECT EXTRACT( MONTH FROM `OrderDate` ) as 'month', cus_order.OrderNo,stock.StockNo,CatName,stock.StockName,OrderQuantity * SellingPrice as TotalPrice,stock.SellingPrice,OrderDate,IFNULL(SUM(OrderQuantity),0)* SUM(SellingPrice) AS Total_Sales FROM cus_order,stock,category WHERE cus_order.StockNo=stock.StockNo AND category.CatNo=stock.CatNo 
...
<br><br><br><br>
  ...
  <center> <table border="1" cellpadding="5" cellspacing="0" width="80%" align="right">
    ...
    <td align="center" height="50" width="3%">No.</td>
     ...
     <td align="center" height="50" width="10%">Items Name</td>
	   <td align="center" height="50" width="10%">Category Name</td>
     ...
     <td align="center" height="50" width="10%">Month </td>
	   <!--  <td align="center" height="50" width="10%">Date</td>
      -->
     <td align="center" height="20" width="10%">Total Sales</td>
    ...
    ?>
            ...
            <td align="center" ><?php echo $row["Total_Sales"];?></td>
      </tr>
               </tr>
         <?php
         $rowNumber++;

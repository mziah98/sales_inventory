...
<head>
 ...
 <!--  <link rel="stylesheet" href="navbar.css"> -->
  ...
  <!--title>PHP and MySQL CRUD</title-->
                ...
                <br><br>
            	<h2><center>Civil&Structure </h2></center>
...
<form action=""  method="post">
            ...
            <a button type="button" onClick="return confirm('Are you sure to delete?')" href="deletec&s.php?StockNo=<?php echo $result2["StockNo"] ;?>" class="btn btn-danger deleteBtn"  data-target="#delete">
				Delete </a>
            </button>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="editc&s.php?StockNo=<?php echo $result2["StockNo"] ;?>"  method="POST">

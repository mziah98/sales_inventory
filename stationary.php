...
<head>
 ...
 <!--  <link rel="stylesheet" href="navbar.css"> -->
  ...
  <!--title>PHP and MySQL CRUD</title-->
                ...
                <br><br>
              <h2><center>Stationary </h2></center>
...
<form action=""  method="post">
              <table align="right" float="right" border="3"  width="100%" cellpadding="2" cellspacing="2">
             ...
             <td><?php echo $i;?></td> 
                   ...
                   <td><?php echo $result2["StockName"];?></td>
                     <td>Rm <?php  echo $result2["StockPrice"];?></td>
                                    
                                    <td>Rm <?php echo $result2["SellingPrice"];?></td>
          ...
          <td>
            ...
            <a button type="button" onClick="return confirm('Are you sure to delete?')" href="deletestock2.php?StockNo=<?php echo $result2["StockNo"] ;?>" class="btn btn-danger deleteBtn"  data-target="#delete">
        Delete </a>
            </button>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="editstationary.php?StockNo=<?php echo $result2["StockNo"] ;?>" method="POST">

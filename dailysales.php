  ...
  <center> <table border="1" cellpadding="5" cellspacing="0" width="80%" align="right">
    ...
    <td align="center" height="50" width="3%">No.</td>
     ...
     <!-- <td align="center" height="50" width="10%">Items Name</td> 
	     <td align="center" height="50" width="10%">Cat Name</td-->
	   <td align="center" height="50" width="10%">Order Quantity</td>
	   <td align="center" height="50" width="10%"> Price (RM) </td>
	   <td align="center" height="50" width="20%">Total Price (RM) </td>
	    <td align="center" height="50" width="20%">Order Date</td>
     
     <td align="center" height="20" width="20%">Total Sales (RM)</td>

...
<head>
 ...
 <!--  <link rel="stylesheet" href="navbar.css"> -->
  ...
  <!--title>PHP and MySQL CRUD</title-->
                ...
                <br><br>
            	<h2><center>Fire Fighting System </h2></center>
...
<form action=""  method="post">
              <table align="right" float="right" border="2"  width="100%" cellpadding="1" cellspacing="0">
                ...
                <tr align="center">
                 <td width="3%" style="background-color:;"> No</td>
                   ...
                   <td width="5%" style="background-color:;">Category No</td>
             ...
             AND category.CatNo=stock.CatNo");
                   ...
                   <td><?php echo $result2["CatNo"];?></td>
					...
					<td><a button type="button"   class="btn btn-success updateBtn"  data-target="#update"> EDIT</button></a>
              
               <!-- 
                  <button type="button" class="btn btn-danger deleteBtn"> <i class="fas fa-trash-alt"></i>  </button> -->

         
            <a button type="button" onClick="return confirm('Are you sure to delete?')" href="deleteff.php?StockNo=<?php echo $result2["StockNo"] ;?>" class="btn btn-danger deleteBtn"  data-target="#delete">
				Delete </a>
            </button>
